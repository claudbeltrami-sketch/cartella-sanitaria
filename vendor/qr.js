/* QRCode, Kazuhiko Arase, MIT license (source headers retained). */
...
}};const cache={};function req(n){if(!cache[n]){const m={exports:{}};cache[n]=m;modules[n](m,m.exports,req)}return cache[n].exports}window.ReportQR=req("./index")})();